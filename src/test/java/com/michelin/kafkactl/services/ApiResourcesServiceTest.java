...
class ApiResourcesServiceTest {
    ...
    void shouldGetResourceDefinitionByCommandNameFound() {
        ...
        Optional<ApiResource> actual = apiResourcesService.getResourceDefinitionByCommandName("topics");
    ...
    void shouldGetResourceDefinitionByCommandNameNotFound() {
        ...
        Optional<ApiResource> actual = apiResourcesService.getResourceDefinitionByCommandName("notFound");
